...
priors <- formatPriors(K = 1000, prior_mean = rep(0,2), prior_sd = rep(sigma0,2), alpha = 10, a = 3, b = 2)
out <- mcmc(data, priors, n_iter = 20000, n_save_P = 100, idx_save = idx_save, thin = 1, verbose = 0)
