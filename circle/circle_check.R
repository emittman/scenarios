...
plot(t(s[[1]]$beta[,15001:20000,g_ran]))
points(t(t$truth[,idx_save[g_ran]+1]), col="blue")
points(t(t$mles[,idx_save[g_ran]+1]), col="red")
par(opar)
...
plot(s[[1]]$beta[1,18001:20000,g_ran], s[[1]]$tau2[g_ran,18001:20000])
...
#occupancy
hist(s[[1]]$max_id[10001:20000], 1000)
hist(s[[1]]$num_occupied[10001:2000])
