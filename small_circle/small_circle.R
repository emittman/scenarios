...
out1 <- mcmc(data, priors, weightMethod="stickBreaking", n_iter = n_iter,
            n_save_P=1, idx_save = idx_save, thin = 1, verbose =3, C=C)
out2 <- mcmc(data, priors, weightMethod="symmDirichlet", n_iter = n_iter,
             n_save_P=n_save_P, idx_save = idx_save, thin = 1, verbose = 0, C=C)
out3 <- mcmc(data, priors, weightMethod="stickBreaking", alpha_fixed = F, n_iter = n_iter,
             n_save_P=1, idx_save = idx_save, thin = 1, verbose =3, C=C)
out4 <- mcmc(data, priors, weightMethod="symmDirichlet", alpha_fixed = F, n_iter = n_iter,
            n_save_P=1, idx_save = idx_save, thin = 1, verbose =3, C=C)
